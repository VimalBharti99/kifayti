        ...
        <div className="container py-5">
            <div className="row g-5">
                <div className="col-lg-4 col-md-6">
                    ...
                    <p className="mb-2"><i className="fa fa-phone-alt me-3"></i><Link className='text-light' to="tel:9873848046">+91-9873848041 </Link></p>
                    <p className="mb-2"><i className="fa fa-envelope me-3"></i><Link className='text-light' to="mailto:yadavrosyrose@gmail.com">yadavrosyrose@gmail.com</Link> </p>
