        ...
        <div id="header-carousel" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
                <div className="carousel-item active">
                    <img className="w-100" src="img/carousel-bg-1.jpg" height="595px" width="100%" alt="Image"/>
                    <div className="carousel-caption d-flex align-items-center">
                        <div className="container">
                            <div className="row align-items-center justify-content-center justify-content-lg-start">
                                <div className="col-10 col-lg-7 text-center text-lg-start">
                                    <h6 className="text-white text-uppercase mb-3 animated slideInDown">// Online shopping Platform //</h6>
                                    <h1 className="display-3 text-white mb-4 pb-3 animated slideInDown">Latest Brands & Collections For You</h1>
                ...
                <div className="carousel-item">
                    <img className="w-100" src="img/carousel-bg-2.jpg" height="595px" width="100%" alt="Image"/>
                    <div className="carousel-caption d-flex align-items-center">
                        <div className="container">
                            <div className="row align-items-center justify-content-center justify-content-lg-start">
                                <div className="col-10 col-lg-7 text-center text-lg-start">
            ...
            <div className="row g-4">
                ...
                <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div className="d-flex py-5 px-4">
                        ...
                        <div className="ps-4">
                            <h5 className="mb-3">Original Products</h5>
                            <p>Diam dolor diam ipsum sit amet diam et eos erat ipsum</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="row g-3">
                                ...
                                <div className="col-12 col-sm-6">
                                    <select className="form-select border-0" style={{height: "55px"}}>
                                        <option defaultValue={0} disabled>Select A Service</option>
