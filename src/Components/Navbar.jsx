        ...
        <div className="row gx-0 d-none d-lg-flex">
            ...
            <div className="col-lg-8 px-5 text-end">
                <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                    ...
                    <small><Link to="tel:9873848046">+91-9873848041 </Link></small>
                </div>
                <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                    <small className="fa fa-envelope text-primary me-2"></small>
                    <small><Link to="mailto:yadavrosyrose@gmail.com">yadavrosyrose@gmail.com </Link></small>
                </div>
            ...
            <div className="navbar-nav ms-auto p-4 p-lg-0">
               ...
               {  
                ...
                <div className="nav-item dropdown  bg-danger">
                        <a to="#" className="nav-link dropdown-toggle text-light" data-bs-toggle="dropdown">Vimal Bharti</a>
                        <div className="dropdown-menu fade-up m-0">
                            <Link to="/profile" className="dropdown-item">Profile</Link>
                            <Link to="/cart" className="dropdown-item">Cart</Link>
                            <Link to="/cheakout" className="dropdown-item">Cheakout</Link>
